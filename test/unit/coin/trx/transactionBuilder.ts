...
describe('Tron', function() {
  ...
  describe('Transaction builder', () => {
    ...
    it('should catch an invalid id', async () => {
      ...
      await txBuilder.build().should.be.rejectedWith('90b8b9eaed51c8bba3b49f7f0e7cc5f21ac99a6f3e2893c663b544bf2c695b1d is not a valid transaction id. Expecting: 80b8b9eaed51c8bba3b49f7f0e7cc5f21ac99a6f3e2893c663b544bf2c695b1d');
    });
  });
});
